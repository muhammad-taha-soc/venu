                ...
                <div className="bg-[#200F36] bg-background-image  text-white rounded-3xl overflow-hidden shadow-lg">
                    <div className="p-8 md:p-12 space-y-6">
                        ...
                        <div className="flex justify-center items-end space-x-4">
                            <button className="bg-[#8B3EF8] hover:bg-purple-600 text-white px-6 py-3 rounded-full text-sm md:text-base font-semibold font-inter transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-opacity-50">
                                Pre-Launch Sign Up
                            </button>
                            <img
